...
Please note Smaller figure provides more robust estimation.
As for the function REGRM, tuning parameter c2 accepts only 4, 6 and 8.  It will be converted appropriately when REGRAM internally calls an appropriate functions.
